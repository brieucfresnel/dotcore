 ...
 * @return void
 */
function dot_the_layout(string $slug, $selector = false) {
 ...
 * @return void
 */
function dot_the_layout_part(string $slug) {
    return acf_get_instance('\DOT\Core\Main\LayoutParts')->the_layout_part($slug);
}
